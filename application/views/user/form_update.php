    ...
    <form method="POST" enctype="multipart/form-data" class="form-horizontal" action="<?php echo base_url() ?>User/prosesUpdate">
      ...
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" placeholder="Password" name="password" aria-describedby="sizing-addon2" value="<?php echo $dataUser->password ?>">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="date" class="form-control" placeholder="Tanggal Lahir" name="tanggal_lahir" aria-describedby="sizing-addon2" value="<?php echo $dataUser->tanggal_lahir ?>">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="file" class="form-control" placeholder="Foto" name="foto" aria-describedby="sizing-addon2" value="<?php echo $dataUser->foto ?>">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
              <textarea class="form-control" name="alamat" rows="10" cols="180" placeholder="Pesan"><?php echo $dataUser->alamat ?></textarea>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" placeholder="Domisili" name="domisili" aria-describedby="sizing-addon2" value="<?php echo $dataUser->domisili ?>">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" placeholder="Kota" name="kota" aria-describedby="sizing-addon2" value="<?php echo $dataUser->kota ?>">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" placeholder="Kodepos" name="kodepos" aria-describedby="sizing-addon2" value="<?php echo $dataUser->kodepos ?>">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" placeholder="Handphone" name="handphone" aria-describedby="sizing-addon2" value="<?php echo $dataUser->handphone ?>">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" placeholder="Pekerjaan" name="pekerjaan" aria-describedby="sizing-addon2" value="<?php echo $dataUser->pekerjaan ?>">
          </div>
        </div>
          ...
          <div class="col-sm-10">
            ...
            <?php
              ...
              foreach ($status as $user) {
                $s = $user == $dataUser->status?'selected':'';
                ?>
