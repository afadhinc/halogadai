            ...
            <div class="col-md-12">
                <div class="kd-imageframe">
                    <div class="row">
                        <div class="col-md-5">
                            <img
                                src="<?php echo base_url() ?>assets/frontend/img/imgMenstruasi/<?php echo $dataBlog->images ?>">
                        </div>
                        <div class="col-md-7">
                            <h1><?php echo $dataBlog->title; ?></h1>
                            <p><?php echo $dataBlog->body; ?></p>

                            <!-- <a href="#" class="frame-btn thbg-color">READ MORE</a> -->
                        </div>
                    </div>
                </div>
            </div>
