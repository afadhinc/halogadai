  ...
  <section class="kd-pagesection" style="background: url('<?php echo base_url(); ?>extraimages/trip-gallerybg.jpg'); background-size: cover; padding: 40px 0px 40px 0px; ">
	<div class="container">
	  <div class="row">
		...
		<div class="col-md-12">
		  ...
		  <div class="kd-subscribe">
			<form>
			  ...
			  <p><input type="submit" value="Subcribe" class="thbg-color"></p>
			</form>
		  </div>
