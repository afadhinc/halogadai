                        ...
                        <div class="col-md-10 col-sm-12">
                            <form>
                                    ...
                                    <div class="col-3">
                                        <div class="card-input-home">
                                            <label>
                                                ...
                                                <img src="<?php echo base_url() ?>/src/image/Motor Black.png "
                                                    class="img-fluid" alt="" />
                                            </label>
                                        </div>
                                        <p>BPKB Motor</p>
                                    ...
                                    <div class="col-3">
                                        <div class="card-input-home">
                                            <label>
                                                ...
                                                <img src="<?php echo base_url() ?>/src/image/Mobil Black.png"
                                                    class="img-fluid" alt="" />
                                            </label>
                                        </div>
                                        <p>BPKB Mobil /Truk</p>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="dana" id="currency-field"
                                        pattern="^\Rp\d{1,3}(,\d{3})*(\.\d+)?Rp " value="" data-type="currency"
...
foreach ($data->result() as $par) {
    ?>
                                        <option value="<?php echo $par->nama_kategori ?>">
                                            <?php echo $par->nama_kategori ?></value>
                                            <?php }?>
...
function hitung() {
    ...
    if (dana === "" || tenor === "" || leasing === "") {
        ...
        Swal.fire({
            ...
            if (result.value) {
                location.href =
                    "https://wa.me/6282321760690?text=Halo Admin, tolong info  Hitungan Pinjaman berikut ini: \n\n*Pilih jaminan* : " +
                    tipe + "\n *Butuh Dana* :" + dana + "\n Tenor :" + tenor + "\n *Leasing* :" + leasing;
            }
        });
