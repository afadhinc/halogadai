<div class="content-wrapper">
  <div class=" col-md-12 well">
    ...
    <h3 style="display:block; text-align:center;">Tambah Data Slider Period Fact</h3>

    <form method="POST" enctype="multipart/form-data" class="form-horizontal" action="<?php echo base_url() ?>Periodfact/prosesTambah">
      <div class="box-body" id="dynamic_field">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="file" class="form-control" placeholder="Foto" name="gambar" aria-describedby="sizing-addon2">
          </div>
        </div>
