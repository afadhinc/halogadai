  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
        <div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
	      ...
	      <div class="col-md-6">
	        <button class="form-control btn btn-primary hapus-dataFaq"> <i class="glyphicon glyphicon-ok-sign"></i> Ya</button>
	      </div>
	      <div class="col-md-6">
...
<script>
 //  	var MyTable = $('#list-data').dataTable({
	...
	// Film
	function tampilFaq() {
		$.get('<?php echo base_url('Faq/tampil'); ?>', function(data) {
	...
	var id_faq;
	$(document).on("click", ".konfirmasiHapus-faq", function() {
		id_faq = $(this).attr("data-id");
	})
	$(document).on("click", ".hapus-dataFaq", function() {
		var id = id_faq;
		
		$.ajax({
			method: "POST",
			url: "<?php echo base_url('Faq/delete'); ?>",
			data: "id=" +id
		})
		// alert(id)
		.done(function(data) {
