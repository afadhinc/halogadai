        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="col-md-2">
                <a href="<?php echo base_url() ?>Pengajuan/tambah">
                  <button class="form-control btn btn-primary"><i class="glyphicon glyphicon-plus-sign"></i> Tambah Data</button>
                </a>
              </div>
              <div class="col-md-2">
                <a href="<?php echo base_url() ?>Pengajuan/export">
                  <button class="form-control btn btn-warning"><i class="glyphicon glyphicon-print"></i> Export Excell</button>
                </a>
              </div>
