...
class Faq extends CI_Controller {
	...
	{
		$data['dataFaq'] = $this->M_faq->select_all();
		$this->load->view('faq/list_data', $data);
	}
	...
	public function update($id) {
		...
		$id= $id;
		$data['dataFaq']= $this->M_faq->select_by_id($id);
		$data['content'] = 'faq/form_update';
		$this->load->view('indexadmin',$data);
	...
	public function prosesUpdate(){
		...
		$this->session->set_flashdata('msg', $out['msg']);
		redirect('Faq/update/'.$data['id_faq']);
	}

	public function delete() {
		$id = $_POST['id'];
		$result = $this->M_faq->delete($id);
