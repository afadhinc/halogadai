             ...
             <div class="col-md-10">
                 <form method="POST" enctype="multipart/form-data" action="<?php echo base_url() ?>Home/prosesTambah">
                     <div class="form-group">
                         ...
                         <input type="text" class="form-control" id="fullName" aria-describedby="fullName" name="nama"
                             required placeholder="Nama lengkap" />
                     </div>
                     <div class="form-group">
                         <!-- <label for="noWA">HP (WhatsApp)</label> -->
                         <input type="text" class="form-control" id="noWA" required name="hp" aria-describedby="noWA"
                             maxlength="13" placeholder="Nomor Whatsapp" />
                     </div>
                     <div class="form-group">
                     ...
                     <div class="form-group">
                         ...
                         <input type="text" class="form-control" id="merekKendaraan" name="id_merk"
                             aria-describedby="merekKendaraan" placeholder="Contoh: Avanza, Xenia" required />
                     </div>
                     <div class="form-group">
                         <!-- <label for="tipeKendaraan">Tipe Kendaraan</label> -->
                         <input type="text" class="form-control" id="tipeKendaraan" aria-describedby="tipeKendaraan"
                             placeholder="Contoh: G, Matic" name="id_tipe" required />
                     </div>
                     <div class="form-group">
                         <!-- <label for="tahunKendaraan">Tahun Kendaraan</label> -->
                         <input type="number" class="form-control" id="tahunKendaraan" aria-describedby="tahunKendaraan"
                             placeholder="Contoh: 2018" min="1900" max="2050" name="tahun" id="tahun" required />
                     </div>
                     <div class="form-group">
                         <!-- <label for="nilaiPinjaman">Nilai Pinjaman</label> -->
                         <input type="number" class="form-control" name="nilai_pinjaman" id="currency-field"
                             pattern="^\Rp\d{1,3}(,\d{3})*(\.\d+)?Rp " value="" data-type="currency" placeholder="Rp" />
                     </div>
                     <div style="margin-left: 20px; padding-bottom: 10px;">
                         <input type="checkbox" class="form-check-input" id="danaMaksimal" value="dana_maksimal"
