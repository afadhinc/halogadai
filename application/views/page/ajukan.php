             ...
             <div class="col-md-10">
                 <form method="POST" enctype="multipart/form-data" action="<?php echo base_url() ?>Home/prosesTambah">
                     <div class="form-group">
                         ...
                         <input type="text" class="form-control" id="fullName" aria-describedby="fullName" name="nama" required />
                     </div>
                     <div class="form-group">
                         <label for="noWA"><b>HP (WhatsApp)</b></label>
                         <input type="text" class="form-control" id="noWA" required name="hp" aria-describedby="noWA" maxlength="13" />
                     </div>
                     <div class="form-group">
                     ...
                     <div class="form-group">
                         <label for="merekKendaraan"><b>Merek Kendaraan</b></label>
                         <input type="text" class="form-control" id="merekKendaraan" name="id_merk" aria-describedby="merekKendaraan" placeholder="Contoh: Avanza, Xenia" required />
                     </div>
                     <div class="form-group">
                         <label for="tipeKendaraan"><b>Tipe Kendaraan</b></label>
                         <input type="text" class="form-control" id="tipeKendaraan" aria-describedby="tipeKendaraan" placeholder="Contoh: G, Matic" name="id_tipe" required />
                     </div>
                     <div class="form-group">
                         <label for="tahunKendaraan"><b>Tahun Kendaraan</b></label>
                         <input type="number" class="form-control" id="tahunKendaraan" aria-describedby="tahunKendaraan" placeholder="Contoh: 2018" min="1900" max="2050" name="tahun" id="tahun" required />
                     </div>
                     <div class="form-group">
                         <label for="nilaiPinjaman"><b>Nilai Pinjaman</b></label>
                         <input type="number" class="form-control" name="nilai_pinjaman" id="currency-field" pattern="^\Rp\d{1,3}(,\d{3})*(\.\d+)?Rp " value="" data-type="currency" placeholder="Rp" />
                     </div>
                     <div class="form-check">
                         <input type="checkbox" class="form-check-input" id="danaMaksimal" value="dana_maksimal" onchange="doalert(this)" />
                         <label class="form-check-label" for="danaMaksimal">Dana Maksimal</label>
                     </div>
                     <div class="form-group">
                     ...
                     <div class="form-group">
                         <label for="tenor"><b>BPKB atas nama</b></label>
                     ...
                     <div class="form-group">
                         <label for="tenor"><b>Leasing</b></label>
                         <select class="custom-select" name="id_leasing">
                             ...
                             <?php $data = $this->db->query("select * from  tbl_kategori_product order by nama_kategori asc");
                                foreach ($data->result() as $par) { ?>
                                 <option value="<?php echo $par->id_kategori_product ?>"><?php echo $par->nama_kategori ?>
                                 </option>
                             <?php } ?>
