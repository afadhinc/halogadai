    ...
    <section class="kd-pagesection" style=" padding: 0px 0px 0px 0px; margin: -30px 0px 0px 0px; ">
        <div class="container full-content">
            <div class="row">
                ...
                <iframe class="resp"
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3961.0612248028997!2d107.6225109145353!3d-6.883269569265643!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e70106290a2d%3A0x71347d8f6ca29829!2sJl.+Konstitusi+No.20%2C+Cigadung%2C+Kec.+Cibeunying+Kaler%2C+Kota+Bandung%2C+Jawa+Barat+40191!5e0!3m2!1sen!2sid!4v1558065799152!5m2!1sen!2sid"
                    width="560" height="315" frameborder="0" style="border:0" allowfullscreen></iframe>
                <!-- Map Secion End -->
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="kd-rich-editor">
                        ...
                        <p>Fill out all required fields to send a message. You have to login to your wordpress account
                            to post any comment. Please don´t spam, thank you!</p>
                    </div>
                    <div id="respond">
                        <form method="post" class="comments-form" id="contactform">
                            ...
                            <p class="kd-textarea"><textarea name="message" placeholder="add your comment"></textarea>
                            </p>
                            <p class="input-block">
