<div class="content-wrapper">
  <div class=" col-md-12 well">
    ...
    <h3 style="display:block; text-align:center;">Tambah Data FAQ</h3>

    <form method="POST" class="form-horizontal" action="<?php echo base_url() ?>Faqhome/prosesTambah">
      ...
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
                <textarea id="editor1" name="deskripsi" rows="10" cols="80" placeholder="Isi Body"></textarea>
          </div>
        </div>
